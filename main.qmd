...
```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:43.802780Z', start_time: '2024-06-03T12:46:43.795295Z'}
import pandas as pd
...
```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:48.728626Z', start_time: '2024-06-03T12:46:48.724488Z'}
...
```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:48.870282Z', start_time: '2024-06-03T12:46:48.840483Z'}
...
```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:49.066309Z', start_time: '2024-06-03T12:46:49.040353Z'}
...
```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:49.173112Z', start_time: '2024-06-03T12:46:49.163463Z'}
# todo add some basic eda here
accounts_df.head()
```

```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:49.385944Z', start_time: '2024-06-03T12:46:49.381821Z'}
accounts_df.nunique()
```

```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:49.954761Z', start_time: '2024-06-03T12:46:49.738723Z'}
plot_categorical_variables(accounts_df, ['account_frequency'])
```

```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:50.407893Z', start_time: '2024-06-03T12:46:50.083300Z'}
...
```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:50.918602Z', start_time: '2024-06-03T12:46:50.576931Z'}
...
```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:50.965782Z', start_time: '2024-06-03T12:46:50.960895Z'}
# todo add some basic eda here
clients_df.head()
```

```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:51.234674Z', start_time: '2024-06-03T12:46:51.224454Z'}
clients_df.describe()
```

```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:52.253928Z', start_time: '2024-06-03T12:46:51.664038Z'}
...
```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:52.265745Z', start_time: '2024-06-03T12:46:52.256747Z'}
dispositions_df = read_csv("data/disp.csv")
dispositions_df.info()
```

```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:52.378199Z', start_time: '2024-06-03T12:46:52.374087Z'}
dispositions_df.head()
```

```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:52.455815Z', start_time: '2024-06-03T12:46:52.448537Z'}
dispositions_df.describe()
```

```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:52.961120Z', start_time: '2024-06-03T12:46:52.852434Z'}
...
```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:53.081161Z', start_time: '2024-06-03T12:46:53.076386Z'}
...
```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:53.562173Z', start_time: '2024-06-03T12:46:53.541316Z'}
...
```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:53.963681Z', start_time: '2024-06-03T12:46:53.958749Z'}
orders_df.head()
```

```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:54.207857Z', start_time: '2024-06-03T12:46:54.198627Z'}
orders_df.describe()
```

```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:54.478325Z', start_time: '2024-06-03T12:46:54.471129Z'}
orders_df.nunique()
```
...
```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:55.518897Z', start_time: '2024-06-03T12:46:54.993168Z'}
plot_categorical_variables(orders_df, ['k_symbol', 'bank_to'])
```

```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:55.974512Z', start_time: '2024-06-03T12:46:55.541985Z'}
...
```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:58.609556Z', start_time: '2024-06-03T12:46:56.088509Z'}
...
```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:58.648455Z', start_time: '2024-06-03T12:46:58.638047Z'}
transactions_df.head()
```

```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:46:58.837522Z', start_time: '2024-06-03T12:46:58.649152Z'}
transactions_df.describe()
```

```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:47:02.571271Z', start_time: '2024-06-03T12:46:58.844956Z'}
plot_categorical_variables(transactions_df, ['transaction_type', 'operation', 'k_symbol'])
```

```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:47:10.069811Z', start_time: '2024-06-03T12:47:02.572795Z'}
...
```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:47:12.128480Z', start_time: '2024-06-03T12:47:10.070947Z'}
...
```{python}
#| ExecuteTime: {end_time: '2024-06-03T12:47:15.722730Z', start_time: '2024-06-03T12:47:12.129671Z'}
