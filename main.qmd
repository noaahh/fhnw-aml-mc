...
```{python}
#| ExecuteTime: {end_time: '2024-06-03T11:39:40.940419Z', start_time: '2024-06-03T11:39:40.932159Z'}
import numpy as np
...
class Visualizer:
    ...
    def plot_feature_importances(self, ax):
        feature_importances = self.trainer.get_trained_model().feature_importances_
        feature_names = self.trainer.feature_columns
        sns.barplot(x=feature_importances, y=feature_names, ax=ax)
        ax.set_title(f'{self.model_name}: Feature Importances')
