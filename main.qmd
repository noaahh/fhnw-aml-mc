...
# Example setup for Decision Tree
decision_tree_model = DecisionTreeClassifier(random_state=42, max_depth=5)  # Limited depth for better interpretability

# Example setup for Linear SVM
linear_svm_model = SVC(kernel='linear', random_state=42)

train_evaluate_model(golden_record_df, feature_columns, decision_tree_model)
train_evaluate_model(golden_record_df, feature_columns, linear_svm_model)
```
